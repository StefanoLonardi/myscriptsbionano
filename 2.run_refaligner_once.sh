...
export PREFIX=cowpea.unitigs
#export REF=$REPO/$PREFIX/$PREFIX.unassembled_unitigs.fasta
export REF=$REPO/$PREFIX/$PREFIX.fasta
#export SILICOMAP=$REPO/$PREFIX/$PREFIX.unassembled_unitigs'_'BspQI.cmap
export SILICOMAP=$REPO/$PREFIX/$PREFIX'_'BspQI.cmap
#export OUT=$REPO/$PREFIX/$PREFIX.unassembled_unitigs'_'BNG_vs_seq
